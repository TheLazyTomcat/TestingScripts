...
SET cmd_line_x86_O1_PP="%fpc_path%" -Twin32 -Pi386 -O1 -vewnhq -dBARE_FPC -FU"%out_dir%" -Fu"%libs_path%" -dPurePascal
SET cmd_line_x86_O3_PP="%fpc_path%" -Twin32 -Pi386 -O3 -vewnhq -dBARE_FPC -FU"%out_dir%" -Fu"%libs_path%" -dPurePascal
SET cmd_line_x64_O1_PP="%fpc_path%" -Twin64 -Px86_64 -O1 -vewnhq -dBARE_FPC -FU"%out_dir%" -Fu"%libs_path%" -dPurePascal
SET cmd_line_x64_O3_PP="%fpc_path%" -Twin64 -Px86_64 -O3 -vewnhq -dBARE_FPC -FU"%out_dir%" -Fu"%libs_path%" -dPurePascal
