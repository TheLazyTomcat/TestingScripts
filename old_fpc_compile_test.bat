...
FOR /R "%bat_dir%..\Dev" %%f IN ("*.pas") DO (
  ECHO FPC - win32 i386 O1 PurePascal | out_split.bat "%log_file%"
  %cmd_line% -Twin32 -Pi386 -O1 -dPurePascal "%%f" | out_split.bat "%log_file%"

  ECHO; | out_split.bat "%log_file%"

  ECHO FPC - win32 i386 O3 PurePascal | out_split.bat "%log_file%"
...
FOR /R "%bat_dir%..\Dev" %%f IN ("*.pas") DO (
  ECHO FPC - win64 x86_64 O1 | out_split.bat "%log_file%"
  %cmd_line% -Twin64 -Px86_64 -O1 "%%f" | out_split.bat "%log_file%"

  ECHO; | out_split.bat "%log_file%"

  ECHO FPC - win64 x86_64 O3 | out_split.bat "%log_file%"
...
FOR /R "%bat_dir%..\Dev" %%f IN ("*.pas") DO (
  ECHO FPC - win64 x86_64 O1 PurePascal | out_split.bat "%log_file%"
  %cmd_line% -Twin64 -Px86_64 -O1 -dPurePascal "%%f" | out_split.bat "%log_file%"

  ECHO; | out_split.bat "%log_file%"
  
  ECHO FPC - win64 x86_64 O3 PurePascal | out_split.bat "%log_file%"
